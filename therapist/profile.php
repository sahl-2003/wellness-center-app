    ...
    <div class="therapist-flex">
        ...
        <div class="therapist-sidebar-custom">
            <div class="text-center mb-4">
                ...
                <?php else: ?>
                        <img src="../image/t1.jpg" alt="Therapist Profile" class="profile-picture">
                <?php endif; ?>
                </div>
            ...
            <ul class="sidebar-nav">
                ...
                <li><a class="sidebar-link <?php if($current_page == 'messages.php') echo 'active'; ?>" href="messages.php"><i class="fas fa-envelope"></i>Messages</a></li>
